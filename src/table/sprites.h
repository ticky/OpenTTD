...
static const uint16 OPENTTD_SPRITE_COUNT = 138;
...
static const SpriteID SPR_SQUARE             = SPR_OPENTTD_BASE + 38; // colored square (used for newgrf compatibility)
static const SpriteID SPR_BLOT               = SPR_OPENTTD_BASE + 39; // colored circle (mainly used as vehicle profit marker and for server compatibility)
...
static const SpriteID SPR_WINDOW_RESIZE      = SPR_OPENTTD_BASE + 44; // resize icon
...
static const SpriteID SPR_SLOPES_BASE              = SPR_CANALS_BASE + CANALS_SPRITE_COUNT;
...
static const uint16 FLAGS_SPRITE_COUNT = 29;
...
static const SpriteID SPR_PLAYER_ICON = 747;
...
static const SpriteID SPR_RAIL_SINGLE_Y           = 1005;
static const SpriteID SPR_RAIL_SINGLE_X           = 1006;
...
static const SpriteID SPR_MONO_SINGLE_Y                 = 1087;
static const SpriteID SPR_MONO_SINGLE_X                 = 1088;
...
static const SpriteID SPR_MGLV_SINGLE_Y                 = 1169;
static const SpriteID SPR_MGLV_SINGLE_X                 = 1170;
...
static const SpriteID SPR_WIRE_X_SHORT      = SPR_ELRAIL_BASE + 0;
static const SpriteID SPR_WIRE_Y_SHORT      = SPR_ELRAIL_BASE + 1;
static const SpriteID SPR_WIRE_EW_SHORT     = SPR_ELRAIL_BASE + 2;
static const SpriteID SPR_WIRE_NS_SHORT     = SPR_ELRAIL_BASE + 3;
static const SpriteID SPR_WIRE_X_SHORT_DOWN = SPR_ELRAIL_BASE + 4;
static const SpriteID SPR_WIRE_Y_SHORT_UP   = SPR_ELRAIL_BASE + 5;
static const SpriteID SPR_WIRE_X_SHORT_UP   = SPR_ELRAIL_BASE + 6;
static const SpriteID SPR_WIRE_Y_SHORT_DOWN = SPR_ELRAIL_BASE + 7;

static const SpriteID SPR_WIRE_X_SW      = SPR_ELRAIL_BASE +  8;
static const SpriteID SPR_WIRE_Y_SE      = SPR_ELRAIL_BASE +  9;
static const SpriteID SPR_WIRE_EW_E      = SPR_ELRAIL_BASE + 10;
static const SpriteID SPR_WIRE_NS_S      = SPR_ELRAIL_BASE + 11;
static const SpriteID SPR_WIRE_X_SW_DOWN = SPR_ELRAIL_BASE + 12;
static const SpriteID SPR_WIRE_Y_SE_UP   = SPR_ELRAIL_BASE + 13;
static const SpriteID SPR_WIRE_X_SW_UP   = SPR_ELRAIL_BASE + 14;
static const SpriteID SPR_WIRE_Y_SE_DOWN = SPR_ELRAIL_BASE + 15;

static const SpriteID SPR_WIRE_X_NE      = SPR_ELRAIL_BASE + 16;
static const SpriteID SPR_WIRE_Y_NW      = SPR_ELRAIL_BASE + 17;
static const SpriteID SPR_WIRE_EW_W      = SPR_ELRAIL_BASE + 18;
static const SpriteID SPR_WIRE_NS_N      = SPR_ELRAIL_BASE + 19;
static const SpriteID SPR_WIRE_X_NE_DOWN = SPR_ELRAIL_BASE + 20;
static const SpriteID SPR_WIRE_Y_NW_UP   = SPR_ELRAIL_BASE + 21;
static const SpriteID SPR_WIRE_X_NE_UP   = SPR_ELRAIL_BASE + 22;
static const SpriteID SPR_WIRE_Y_NW_DOWN = SPR_ELRAIL_BASE + 23;

/* Tunnel entries */
static const SpriteID SPR_WIRE_TUNNEL_NE = SPR_ELRAIL_BASE + 24;
static const SpriteID SPR_WIRE_TUNNEL_SE = SPR_ELRAIL_BASE + 25;
static const SpriteID SPR_WIRE_TUNNEL_SW = SPR_ELRAIL_BASE + 26;
static const SpriteID SPR_WIRE_TUNNEL_NW = SPR_ELRAIL_BASE + 27;

/* Depot entries */
static const SpriteID SPR_WIRE_DEPOT_SW = SPR_ELRAIL_BASE + 24;
static const SpriteID SPR_WIRE_DEPOT_NW = SPR_ELRAIL_BASE + 25;
static const SpriteID SPR_WIRE_DEPOT_NE = SPR_ELRAIL_BASE + 26;
static const SpriteID SPR_WIRE_DEPOT_SE = SPR_ELRAIL_BASE + 27;


/* Pylons, first identifier is the direction of the track, second the placement relative to the track */
static const SpriteID SPR_PYLON_Y_NE = SPR_ELRAIL_BASE + 28;
static const SpriteID SPR_PYLON_Y_SW = SPR_ELRAIL_BASE + 29;
static const SpriteID SPR_PYLON_X_NW = SPR_ELRAIL_BASE + 30;
static const SpriteID SPR_PYLON_X_SE = SPR_ELRAIL_BASE + 31;
static const SpriteID SPR_PYLON_EW_N = SPR_ELRAIL_BASE + 32;
static const SpriteID SPR_PYLON_EW_S = SPR_ELRAIL_BASE + 33;
static const SpriteID SPR_PYLON_NS_W = SPR_ELRAIL_BASE + 34;
static const SpriteID SPR_PYLON_NS_E = SPR_ELRAIL_BASE + 35;
...
static const SpriteID SPR_FLAT_1_QUART_SNOWY_TILE = 4493;
static const SpriteID SPR_FLAT_2_QUART_SNOWY_TILE = 4512;
static const SpriteID SPR_FLAT_3_QUART_SNOWY_TILE = 4531;
static const SpriteID SPR_FLAT_SNOWY_TILE         = 4550;
...
static const SpriteID SPR_BTTUB_X_FRONT_MID       = 2660;
...
static const PaletteID PALETTE_RECOLOR_START       = 0x307;
